...
SET @extractstart = '2016-02-29';
SET @extractend = '2016-03-07'; -- this must be the day after
...
SELECT 
    ...
    (SELECT name
        FROM oms_live.ims_sales_order_item_status
        WHERE id_sales_order_item_status = oms_ver.fk_sales_order_item_status) 'payment_verification_status',
    oms_ver.created_at 'payment_verification_date',
    (SELECT name
        FROM oms_live.ims_sales_order_item_status
        WHERE id_sales_order_item_status = oms_soi.fk_sales_order_item_status) 'item_status',
