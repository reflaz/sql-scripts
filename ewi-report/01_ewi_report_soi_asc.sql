...
FROM
    ...
    LEFT JOIN oms_live.oms_package_status_history psh_ship ON psh_ship.fk_package = pa.id_package
        AND psh_ship.id_package_status_history = (SELECT 
	...
	LEFT JOIN oms_live.oms_package_status_history psh_delv ON psh_delv.fk_package = pa.id_package
        AND psh_delv.id_package_status_history = (SELECT 
            MIN(id_package_status_history)
        FROM
            oms_live.oms_package_status_history
        WHERE
