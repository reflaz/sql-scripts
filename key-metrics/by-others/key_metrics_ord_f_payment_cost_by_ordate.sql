...
FROM
    (SELECT 
        payment_method,
            ...
            SUM(IF(seller_type = 'RETAIL', payment_cost + mdr, 0)) 'total_payment_cost_retail',
            ...
            SUM(IF(seller_type = 'CB', payment_cost + mdr, 0)) 'total_payment_cost_cb',
            ...
            SUM(IF(seller_type = 'MA-VIP', unit_price, 0)) 'unit_price_ma_vip',
            ...
            SUM(IF(seller_type = 'MA-VIP', payment_cost + mdr, 0)) 'total_payment_cost_ma_vip',
            ...
            SUM(IF(seller_type = 'MA-NON-VIP', unit_price, 0)) 'unit_price_ma_non_vip',
            ...
            SUM(IF(seller_type = 'MA-NON-VIP', payment_cost + mdr, 0)) 'total_payment_cost_ma_non_vip',
            ...
            SUM(IF(seller_type = 'DB', unit_price, 0)) 'unit_price_db',
            ...
            SUM(IF(seller_type = 'DB', payment_cost + mdr, 0)) 'total_payment_cost_db',
            ...
            SUM(mdr) 'mdr',
            SUM(payment_cost + mdr) 'total_payment_cost',
    ...
    FROM
        ...
        so.created_at 'order_created',
            ...
            END 'tenor',
            CASE
                WHEN so.payment_method = 'CashOnDelivery' THEN '1.5%'
                WHEN so.payment_method = 'NoPayment' THEN 0
                ELSE '2.03%'
            END 'payment_cost_rate',
            CASE
                WHEN
                    ins.tenor = 3
                THEN
            ...
            END 'mdr_rate',
            CASE
                WHEN so.payment_method = 'CashOnDelivery' THEN (IFNULL(soi.paid_price, 0) + IFNULL(soi.shipping_surcharge, 0) + IFNULL(soi.shipping_amount, 0)) * 1.5 / 100
                WHEN so.payment_method = 'NoPayment' THEN 0
