/*-----------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------
Key Metrics Summarization - Level 4
...
FROM
    (SELECT 
        lvl1,
            ...
            SUM(IF(seller_type = 'MP', nmv, 0)) 'nmv_mp',
            COUNT(DISTINCT IF(seller_type = 'RETAIL', id_sales_order, NULL)) 'count_so_retail',
            COUNT(DISTINCT IF(seller_type = 'CB', id_sales_order, NULL)) 'count_so_cb',
            COUNT(DISTINCT IF(seller_type = 'MP', id_sales_order, NULL)) 'count_so_mp',
            COUNT(IF(seller_type = 'RETAIL', bob_id_sales_order_item, NULL)) 'count_soi_retail',
            COUNT(IF(seller_type = 'CB', bob_id_sales_order_item, NULL)) 'count_soi_cb',
            COUNT(IF(seller_type = 'MP', bob_id_sales_order_item, NULL)) 'count_soi_mp',
            SUM(IF(seller_type = 'RETAIL', unit_price, 0)) 'unit_price_retail',
            SUM(IF(seller_type = 'CB', unit_price, 0)) 'unit_price_cb',
            SUM(IF(seller_type = 'MP', unit_price, 0)) 'unit_price_mp',
            SUM(IF(seller_type = 'RETAIL', retail_cogs, 0)) 'cogs_retail',
    ...
    FROM
        ...
        so.created_at 'order_date',
            ...
            END 'seller_type',
            CASE
                WHEN catree.lvl2_id IN (14737 , 3394, 3424, 9139, 3484, 14809, 11745, 15213, 15221) THEN catree.lvl2_id
                WHEN catree.lvl3_id IN (3559 , 11706, 9258, 15187) THEN catree.lvl3_id
                WHEN catree.lvl4_id IN (15136 , 15113, 15116, 15129) THEN catree.lvl4_id
                WHEN catree.lvl1_id IN (3425 , 3441, 3476, 3377) THEN catree.lvl1_id
                ELSE 'others'
            END 'lv_group',
            CASE
                WHEN catree.lvl2_id IN (14737 , 3394, 3424, 9139, 3484, 14809, 11745, 15213, 15221) THEN catree.lvl1
                WHEN catree.lvl3_id IN (3559 , 11706, 9258, 15187) THEN catree.lvl1
                WHEN catree.lvl4_id IN (15136 , 15113, 15116, 15129) THEN catree.lvl1
                WHEN catree.lvl1_id IN (3425 , 3441, 3476, 3377) THEN catree.lvl1
                ELSE 'others'
            END 'lvl1',
            CASE
                WHEN catree.lvl2_id IN (14737 , 3394, 3424, 9139, 3484, 14809, 11745, 15213, 15221) THEN catree.lvl2
                WHEN catree.lvl3_id IN (3559 , 11706, 9258, 15187) THEN catree.lvl2
                WHEN catree.lvl4_id IN (15136 , 15113, 15116, 15129) THEN catree.lvl2
                ELSE 'others'
            END 'lvl2',
            CASE
                WHEN catree.lvl2_id IN (14737 , 3394, 3424, 9139, 3484, 14809, 11745, 15213, 15221) THEN 'all'
                WHEN catree.lvl3_id IN (3559 , 11706, 9258, 15187) THEN catree.lvl3
                WHEN catree.lvl4_id IN (15136 , 15113, 15116, 15129) THEN catree.lvl3
                ELSE 'others'
            END 'lvl3',
            CASE
                WHEN catree.lvl2_id IN (14737 , 3394, 3424, 9139, 3484, 14809, 11745, 15213, 15221) THEN 'all'
                WHEN catree.lvl3_id IN (3559 , 11706, 9258, 15187) THEN 'all'
                WHEN catree.lvl4_id IN (15136 , 15113, 15116, 15129) THEN catree.lvl4
                ELSE 'others'
            END 'lvl4'
    FROM
