...
SET @extractend = '2016-11-03'; -- This MUST be D + 1
...
FROM
    ...
    HAVING supplier_type = 'supplier'
        OR tax_class = 0) result) result
    GROUP BY lvl1_id , payment_method , payment_type , bank , tenor) result