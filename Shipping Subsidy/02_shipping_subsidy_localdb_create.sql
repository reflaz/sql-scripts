CREATE DATABASE  IF NOT EXISTS `ship_subsidy` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ship_subsidy`;
...
CREATE TABLE `oms_data` (
    ...
    PRIMARY KEY (`bob_id_sales_order_item` , `order_nr` , `origin` , `id_package_dispatching` , `id_supplier` , `id_district`)
