...
DELETE ac FROM scgl.anondb_calculate ac
        JOIN
    scgl.anondb_extract_update au ON ac.bob_id_sales_order_item = au.bob_id_sales_order_item;
...
FROM
    ...
    FROM
        ...
        ae.*,
            ...
            END 'active'
    FROM
        scgl.anondb_extract_update ae) ae) ae
