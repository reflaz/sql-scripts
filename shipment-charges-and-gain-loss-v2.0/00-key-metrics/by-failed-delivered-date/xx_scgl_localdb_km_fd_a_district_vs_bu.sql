...
FROM
    (SELECT 
        zone_type,
            SUM(IF(business_unit = 'MP', nmv, 0)) 'nmv_mp',
            SUM(IF(business_unit = 'MP', nmv, 0)) / MAX(IF(business_unit = 'MP', total_nmv, NULL)) 'nmv_mp_proportion',
            SUM(IF(business_unit = 'MP', count_soi, 0)) 'count_soi_mp',
            SUM(IF(business_unit = 'MP', count_soi, 0)) / MAX(IF(business_unit = 'MP', total_count_soi, NULL)) 'count_soi_mp_proportion',
            SUM(IF(business_unit = 'MP', gain_loss, 0)) 'gain_loss_mp',
            SUM(IF(business_unit = 'MP', gain_loss, 0)) / MAX(IF(business_unit = 'MP', total_gain_loss, NULL)) 'gain_loss_mp_proportion',
            SUM(IF(business_unit = 'MP', gain_loss, 0)) / SUM(IF(business_unit = 'MP', count_soi, 0)) 'cost_per_item_mp',
