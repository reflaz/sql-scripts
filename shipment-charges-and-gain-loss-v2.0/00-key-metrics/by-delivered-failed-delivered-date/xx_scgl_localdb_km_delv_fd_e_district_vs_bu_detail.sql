...
FROM
    (SELECT 
        zone_type,
            SUM(IF(business_unit = 'MA', nmv, 0)) 'nmv_ma',
            SUM(IF(business_unit = 'MA', nmv, 0)) / MAX(IF(business_unit = 'MA', total_nmv, NULL)) 'nmv_ma_proportion',
            SUM(IF(business_unit = 'MA', count_soi, 0)) 'count_soi_ma',
            SUM(IF(business_unit = 'MA', count_soi, 0)) / MAX(IF(business_unit = 'MA', total_count_soi, NULL)) 'count_soi_ma_proportion',
            SUM(IF(business_unit = 'MA', gain_loss, 0)) 'gain_loss_ma',
            SUM(IF(business_unit = 'MA', gain_loss, 0)) / MAX(IF(business_unit = 'MA', total_gain_loss, NULL)) 'gain_loss_ma_proportion',
            SUM(IF(business_unit = 'MA', gain_loss, 0)) / SUM(IF(business_unit = 'MA', count_soi, 0)) 'cost_per_item_ma',
            SUM(IF(business_unit = 'MA', PC1, 0)) 'pc1_ma',
            SUM(IF(business_unit = 'MA', PC1, 0)) / SUM(IF(business_unit = 'MA', count_soi, 0)) 'pc1_per_item_ma',
            SUM(IF(business_unit = 'MA', PC2, 0)) 'pc2_ma',
            SUM(IF(business_unit = 'MA', PC2, 0)) / SUM(IF(business_unit = 'MA', count_soi, 0)) 'pc2_per_item_ma',
            SUM(IF(business_unit = 'DB', nmv, 0)) 'nmv_db',
            SUM(IF(business_unit = 'DB', nmv, 0)) / MAX(IF(business_unit = 'DB', total_nmv, NULL)) 'nmv_db_proportion',
            SUM(IF(business_unit = 'DB', count_soi, 0)) 'count_soi_db',
            SUM(IF(business_unit = 'DB', count_soi, 0)) / MAX(IF(business_unit = 'DB', total_count_soi, NULL)) 'count_soi_db_proportion',
            SUM(IF(business_unit = 'DB', gain_loss, 0)) 'gain_loss_db',
            SUM(IF(business_unit = 'DB', gain_loss, 0)) / MAX(IF(business_unit = 'DB', total_gain_loss, NULL)) 'gain_loss_db_proportion',
            SUM(IF(business_unit = 'DB', gain_loss, 0)) / SUM(IF(business_unit = 'DB', count_soi, 0)) 'cost_per_item_db',
            SUM(IF(business_unit = 'DB', PC3, 0)) 'pc3_db',
            SUM(IF(business_unit = 'Retail', nmv, 0)) 'nmv_retail',
            SUM(IF(business_unit = 'Retail', nmv, 0)) / MAX(IF(business_unit = 'Retail', total_nmv, NULL)) 'nmv_retail_proportion',
            SUM(IF(business_unit = 'Retail', count_soi, 0)) 'count_soi_retail',
            SUM(IF(business_unit = 'Retail', count_soi, 0)) / MAX(IF(business_unit = 'Retail', total_count_soi, NULL)) 'count_soi_retail_proportion',
            SUM(IF(business_unit = 'Retail', gain_loss, 0)) 'gain_loss_retail',
            SUM(IF(business_unit = 'Retail', gain_loss, 0)) / MAX(IF(business_unit = 'Retail', total_gain_loss, NULL)) 'gain_loss_retail_proportion',
            SUM(IF(business_unit = 'Retail', gain_loss, 0)) / SUM(IF(business_unit = 'Retail', count_soi, 0)) 'cost_per_item_retail',
            SUM(IF(business_unit = 'Cross Border', nmv, 0)) 'nmv_cb',
            SUM(IF(business_unit = 'Cross Border', nmv, 0)) / MAX(IF(business_unit = 'Cross Border', total_nmv, NULL)) 'nmv_cb_proportion',
            SUM(IF(business_unit = 'Cross Border', count_soi, 0)) 'count_soi_cb',
            SUM(IF(business_unit = 'Cross Border', count_soi, 0)) / MAX(IF(business_unit = 'Cross Border', total_count_soi, NULL)) 'count_soi_cb_proportion',
            SUM(IF(business_unit = 'Cross Border', gain_loss, 0)) 'gain_loss_cb',
            SUM(IF(business_unit = 'Cross Border', gain_loss, 0)) / MAX(IF(business_unit = 'Cross Border', total_gain_loss, NULL)) 'gain_loss_cb_proportion',
            SUM(IF(business_unit = 'Cross Border', gain_loss, 0)) / SUM(IF(business_unit = 'Cross Border', count_soi, 0)) 'cost_per_item_cb',
            SUM(nmv) 'nmv',
    ...
    FROM
        ...
        *,
            ...
            CASE
                ...
                WHEN
                    fk_shipment_scheme = 3
                        AND zone_type LIKE '%paid%'
                THEN
                    shipping_amount / 1.1
            ...
            CASE
                WHEN fk_shipment_scheme = 5 THEN (@cb_delivery_charge - @cb_delivery_cost) * qty
                ELSE IFNULL(total_shipment_fee_mp_seller, 0) + IFNULL(shipping_fee_to_customer, 0) - IFNULL(total_delivery_cost, 0) - IF(fk_shipment_scheme IN (2 , 3, 4)
