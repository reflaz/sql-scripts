...
FROM
    (SELECT 
        ac.bob_id_supplier 'Seller ID',
            ...
            SUM(IFNULL(ac.sc_fee_2, 0)) 'Shipping fee credit received',
            SUM(IFNULL(ac.sc_fee_3, 0)) 'Shipping Reimbursement Received',
            SUM(CASE
            ...
            SUM(commission_waiver) 'Commission waivers - NULL',
            ...
            SUM(CASE
                ...
                ELSE IFNULL(total_shipment_fee_mp_seller, 0) + IFNULL(shipping_fee_to_customer, 0) - IFNULL(total_shipment_cost, 0) - IFNULL(total_insurance_charge, 0)
            ...
            (SELECT 
                ...
                WHERE
                    ae.order_nr = ac.order_nr
                        ...
                        AND IFNULL(ae.id_package_dispatching, 1) = IFNULL(ac.id_package_dispatching, 1)) 'commission_waiver',
            CASE
                WHEN
