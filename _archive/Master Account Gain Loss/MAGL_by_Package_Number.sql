/*-----------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------
Master Account Shipping Surcharge by Package Number
...
Instructions	: Insert formatted Package Number in WHERE oms_pck.package_number IN () << part of the script. You can format the ID in
...
WHERE
    oms_pck.package_number IN ('')
GROUP BY oms_pck.package_number;