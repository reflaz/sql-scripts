...
SELECT 
    ...
    total_shipping_amount 'Total Charge to Customer',
    ...
    CASE
        ...
        WHEN zone = 'Free Zone' THEN (shipment_rate - 7000) * total_rounded_weight_non_bulky * - 1
        ELSE 0
    END 'PC3'
FROM
    (SELECT 
        oms.*,
            ...
            ((shipment_rate * total_rounded_weight * (1 - shipment_discount_rate)) + (ins_3pl * (1 + ins_3pl_vat_rate))) * - 1 'total_charge_from_3pl'
    FROM
        (SELECT 
        oms.*,
            CASE
