...
CREATE DATABASE  IF NOT EXISTS `masc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `masc`;
...
CREATE TABLE `oms` (
    ...
    `total_unit_price` DECIMAL(17 , 2 ) DEFAULT NULL,
    `total_paid_price` DECIMAL(17 , 2 ) DEFAULT NULL,
    `total_shipping_surcharge` DECIMAL(17 , 2 ) DEFAULT NULL,
