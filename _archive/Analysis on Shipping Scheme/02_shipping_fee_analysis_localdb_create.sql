CREATE DATABASE  IF NOT EXISTS `ship_fee_anz` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ship_fee_anz`;
...
CREATE TABLE `oms_data` (
    ...
    `sc_id_sales_order_item` INT(10) DEFAULT NULL,
    ...
    `id_package_dispatching` INT(10) DEFAULT NULL,
    `tracking_number` VARCHAR(50) DEFAULT NULL,
    `fk_shipment_provider` int(10) DEFAULT NULL,
