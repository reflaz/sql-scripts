...
FROM
    (SELECT 
        id_supplier,
            ...
            SUM(IF(created_at >= '2016-08-01'
                AND created_at < '2016-09-01', paid_price, 0)) 'nmv_08',
            COUNT(DISTINCT IF(created_at >= '2016-08-01'
                AND created_at < '2016-09-01', id_sales_order, NULL)) 'count_so_08',
            COUNT(IF(created_at >= '2016-08-01'
                AND created_at < '2016-09-01', id_sales_order_item, NULL)) 'count_soi_08',
            SUM(IF(created_at >= '2016-09-01'
                AND created_at < '2016-10-01', paid_price, 0)) 'nmv_09',
            COUNT(DISTINCT IF(created_at >= '2016-09-01'
                AND created_at < '2016-10-01', id_sales_order, NULL)) 'count_so_09',
            COUNT(IF(created_at >= '2016-09-01'
                AND created_at < '2016-10-01', id_sales_order_item, NULL)) 'count_soi_09',
            SUM(IF(created_at >= '2016-09-01'
                AND created_at < '2016-09-20', paid_price, 0)) 'nmv_mtd_09',
            COUNT(DISTINCT IF(created_at >= '2016-09-01'
                AND created_at < '2016-09-20', id_sales_order, NULL)) 'count_so_mtd_09',
            COUNT(IF(created_at >= '2016-09-01'
                AND created_at < '2016-09-20', id_sales_order_item, NULL)) 'count_soi_mtd_09',
            SUM(IF(created_at >= '2016-10-01'
                AND created_at < '2016-10-20', paid_price, 0)) 'nmv_mtd_10',
            COUNT(DISTINCT IF(created_at >= '2016-10-01'
                AND created_at < '2016-10-20', id_sales_order, NULL)) 'count_so_mtd_10',
            COUNT(IF(created_at >= '2016-10-01'
                AND created_at < '2016-10-20', id_sales_order_item, NULL)) 'count_soi_mtd_10'
    FROM
        (SELECT 
        so.id_sales_order,
    ...
    GROUP BY id_supplier , campaign) result