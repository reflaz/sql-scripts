...
CREATE TABLE IF NOT EXISTS `anondb_extract_item_level` (
...
CREATE TABLE IF NOT EXISTS `api_direct_billing` (
...
CREATE TABLE IF NOT EXISTS `api_master_account` (
...
CREATE TABLE IF NOT EXISTS `weight_threshold_seller` (
