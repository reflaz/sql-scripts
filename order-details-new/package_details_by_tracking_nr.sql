...
FROM
    ...
    FROM
        ...
        soi.bob_id_sales_order_item,
            ...
            pck.package_number,
            pck.invoice_number,
            pck.first_tracking_number,
            pck.first_shipment_provider,
            pck.last_tracking_number,
            pck.last_shipment_provider,
            CASE
    ...
    LEFT JOIN oms_live.wms_inventory inv ON inv.id_inventory = pi.fk_inventory
    LEFT JOIN oms_live.ims_purchase_order_item poi ON poi.id_purchase_order_item = inv.fk_purchase_order_item
    ...
    LEFT JOIN bob_live.shipping_fee_origin_mapping sfom ON sa.fk_country = sfom.fk_country
        ...
        WHERE
            fk_country = sa.fk_country
                ...
                AND is_live = 1)
    LEFT JOIN asc_live.seller ascsel ON sup.id_supplier = ascsel.src_id) res) result
