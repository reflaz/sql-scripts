...
CREATE TABLE IF NOT EXISTS `api_data` (
    ...
    UNIQUE KEY (`fk_api_type` , `api_date` , `posting_type` , `charge_type` , `is_actual` , `is_marketplace` , `package_number` , `short_code`),
    KEY (`fk_api_type`),
    KEY (`api_date`),
    KEY (`posting_type`),
    KEY (`charge_type`),
...
CREATE TABLE IF NOT EXISTS `fms_sales_order_item` (
    ...
    `sc_id_sales_order_item` INT(10) UNSIGNED DEFAULT NULL,
    `oms_id_sales_order_item` INT(10) UNSIGNED DEFAULT NULL,
    ...
    `commission_adjustment` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_fee` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_fee_adjustment` DECIMAL(20 , 4 ) DEFAULT NULL,
    `auto_shipping_fee` DECIMAL(20 , 4 ) DEFAULT NULL,
    `manual_shipping_fee_lzd` DECIMAL(20 , 4 ) DEFAULT NULL,
    `manual_shipping_fee_3p` DECIMAL(20 , 4 ) DEFAULT NULL,
