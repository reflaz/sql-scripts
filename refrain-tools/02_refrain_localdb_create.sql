...
CREATE TABLE IF NOT EXISTS `tmp_item_level` (
    ...
    `payment_cost_mdr_rate` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_cost_ipp_rate` DECIMAL(20 , 4 ) DEFAULT NULL,
    `customer_charge_pct` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_flat_cost` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_cost_mdr` DECIMAL(20 , 4 ) DEFAULT NULL,
    `payment_cost_ipp` DECIMAL(20 , 4 ) DEFAULT NULL,
    ...
    `item_weight_seller_flag` TINYINT(4) DEFAULT 0,
