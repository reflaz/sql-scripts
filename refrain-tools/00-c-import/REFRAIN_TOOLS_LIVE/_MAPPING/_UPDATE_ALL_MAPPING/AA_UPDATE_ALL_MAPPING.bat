...
del /q "C:\REFRAIN_TOOLS_LIVE\_MAPPING\MAP_ORIGIN_MAPPING\*.csv" >nul
...
copy "C:\REFRAIN_TOOLS_LIVE\_MAPPING\_UPDATE_ALL_MAPPING\map-origin-mapping\*.csv" "C:\REFRAIN_TOOLS_LIVE\_MAPPING\MAP_ORIGIN_MAPPING\" >nul
...
cd "C:\REFRAIN_TOOLS_LIVE\_MAPPING\MAP_ORIGIN_MAPPING\"
