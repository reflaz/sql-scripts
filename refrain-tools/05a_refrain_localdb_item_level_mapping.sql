...
UPDATE tmp_item_level til
    ...
    map_campaign mcam ON mct.fk_campaign = mcam.id_campaign
        AND IFNULL(til.first_shipment_provider, 'first_shipment_provider') = COALESCE(mcam.first_shipment_provider, til.first_shipment_provider, 'first_shipment_provider')
