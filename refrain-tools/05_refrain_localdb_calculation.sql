...
SET
    ...
    tpl.pickup_cost = IFNULL(pckc.discount, 0),
    tpl.pickup_cost_vat = IFNULL(pckc.tax_amount, 0),
    tpl.delivery_cost = COALESCE(delv.amount, fdel.amount, 0),
    tpl.delivery_cost_vat = COALESCE(delv.discount, fdel.discount, 0),
...
ON DUPLICATE KEY UPDATE
	...
	sc_sales_order_item = til.sc_sales_order_item,
	...
	auto_shipping_fee_credit = til.auto_shipping_fee_credit,
	manual_shipping_fee = til.manual_shipping_fee,
