...
CREATE TABLE `category_tree` (
  ...
  `id_commercial_category` varchar(12) DEFAULT NULL,
  `level1_commercial` varchar(255) DEFAULT NULL,
  `level2_commercial` varchar(255) DEFAULT NULL,
  `level3_commercial` varchar(255) DEFAULT NULL,
  `level4_commercial` varchar(255) DEFAULT NULL,
  `level5_commercial` varchar(255) DEFAULT NULL,
  `level6_commercial` varchar(255) DEFAULT NULL,
  `commercial_category` varchar(255) DEFAULT NULL,
  ...
  KEY `id_commercial_category` (`id_commercial_category`)
