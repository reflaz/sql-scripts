...
SET @extractend = '2016-12-02';-- This MUST be D + 1
            ...
            IFNULL((SELECT 
                ...
                WHERE
                    ref = ascsoi.id_sales_order_item
                        AND fk_transaction_type = 16), (SELECT 
                    value
                FROM
                    asc_live.transaction_pending
                WHERE
                    ref = ascsoi.id_sales_order_item
                        AND fk_transaction_type = 16)) 'marketplace_commission_fee',
