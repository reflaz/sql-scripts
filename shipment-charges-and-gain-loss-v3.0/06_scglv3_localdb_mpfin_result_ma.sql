/*-----------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------
Shipping Charges and Gain/Loss Get
...
SELECT 
    ...
    SUM(shipping_fee_credit) 'shipping_fee',
    SUM(seller_cr_db_item) 'shipping_fee',
    zone_type,
    ...
    SUM(shipment_cost_item) 'shipment_cost',
    SUM(shipment_cost_discount_item) 'shipment_cost_discount',
    SUM(shipment_cost_vat_item) 'shipment_cost_vat',
    ...
    SUM(total_shipment_cost_item) 'total_shipment_cost',
