...
FROM
    (SELECT 
        *,
            to_be_shipment_fee_mp_seller + to_be_shipping_fee_to_cust - total_delivery_cost 'to_be_gain_loss',
            to_be_shipment_fee_mp_seller + to_be_shipping_fee_to_cust - total_delivery_cost - gain_loss 'impact_to_ebitda'
    FROM
        (SELECT 
        ac.*,
