...
FROM
    ...
    LEFT JOIN oms_live.wms_inventory inv ON sri.fk_inventory = inv.id_inventory
    LEFT JOIN oms_live.ims_sales_order_item soi ON inv.sales_order_item_id = soi.id_sales_order_item
